...
<head>
    ...
    <meta name="description" content="Luxury cottage with private plunge pool at Wildernest Nature Resort. Perfect for couples seeking a romantic, nature-inspired escape.">
    ...
    <?php
    $page_title = "Private Plunge Pool Cottage | Wildernest Nature Resort";
    $page_description = "Luxury cottage with private plunge pool at Wildernest Nature Resort. Perfect for couples seeking a romantic, nature-inspired escape.";
...
<main class="flex-grow">
    ...
    <div class="relative">
        <div class="h-screen max-h-[500px] bg-cover bg-center overflow-hidden">
            <img src="assets/images/cta-bg.svg" alt="Private Plunge Pool Cottage" class="w-full h-full object-cover">
        ...
        <div class="absolute inset-0 container mx-auto px-4 sm:px-6 flex items-center">
            <div class="relative grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 items-center w-full">
                ...
                <div class="max-w-2xl mt-16 md:mt-20 mx-auto lg:mx-0 text-center lg:text-left px-4 sm:px-0" data-aos="fade-up" data-aos-duration="800">
                    ...
                    <div class="flex flex-row flex-wrap justify-center lg:justify-start gap-3 sm:gap-4">
                        ...
                        <div class="flex-shrink-0 flex items-center text-white bg-white/10 px-3 sm:px-4 py-2 sm:py-3 filter backdrop-blur-xl rounded-4xl">
                            ...
                            <span class="text-xl sm:text-2xl font-bold">₹12,000</span>
                            <span class="ml-1 line-through text-gray-300 text-sm sm:text-base">₹12,500</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative w-full h-[250px] sm:h-[300px] mt-8 lg:mt-16 hidden md:block" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                    <img src="assets/images/PlungePoolAC/2.png" alt="Private Plunge Pool Cottage" class="absolute inset-0 w-full h-full rounded-2xl object-cover shadow-2xl border-4 border-white/20 transition-transform duration-700 hover:scale-[1.02]" loading="lazy">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 justify-center">
                <div class="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 text-center sm:text-left justify-center" data-aos="fade-up" data-aos-duration="500">
                    ...
                    <span class="font-medium text-gray-800 dark:text-gray-200 text-sm sm:text-base">Private plunge pool</span>
                </div>
                <div class="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 text-center sm:text-left justify-center" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
                    ...
                    <span class="font-medium text-gray-800 dark:text-gray-200 text-sm sm:text-base">Stunning valley views</span>
                </div>
                <div class="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 text-center sm:text-left justify-center" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200">
                    ...
                    <span class="font-medium text-gray-800 dark:text-gray-200 text-sm sm:text-base">All meals included</span>
                </div>
                <div class="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 text-center sm:text-left justify-center" data-aos="fade-up" data-aos-duration="500" data-aos-delay="300">
                    ...
                    <span class="font-medium text-gray-800 dark:text-gray-200 text-sm sm:text-base">Nature-inspired design</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div data-aos="fade-right">
                    <div class="relative rounded-2xl overflow-hidden mb-4 aspect-[4/3]">
                        <img id="mainImage" src="assets/images/PlungePoolAC/1.jpg" alt="Private Plunge Pool Cottage view 1" class="w-full h-full object-cover transition-opacity duration-300">
                    ...
                    <div class="grid grid-cols-4 gap-2">
                        <button onclick="changeImage('assets/images/PlungePoolAC/1.jpg', 0)" class="w-[140px] h-[140px] rounded-lg overflow-hidden transition-all ring-2 ring-amber-500 scale-105">
                            <img src="assets/images/PlungePoolAC/1.jpg" alt="Thumbnail 1" class="w-full h-full object-cover">
                        </button>
                        <button onclick="changeImage('assets/images/PlungePoolAC/2.png', 1)" class="w-[140px] h-[140px] rounded-lg overflow-hidden transition-all opacity-80 hover:opacity-100">
                            <img src="assets/images/PlungePoolAC/2.png" alt="Thumbnail 2" class="w-full h-full object-cover">
                        </button>
                        <button onclick="changeImage('assets/images/PlungePoolAC/3.jpg', 2)" class="w-[140px] h-[140px] rounded-lg overflow-hidden transition-all opacity-80 hover:opacity-100">
                            <img src="assets/images/PlungePoolAC/3.jpg" alt="Thumbnail 3" class="w-full h-full object-cover">
                        </button>
                        <button onclick="changeImage('assets/images/PlungePoolAC/4.jpg', 3)" class="w-[140px] h-[140px] rounded-lg overflow-hidden transition-all opacity-80 hover:opacity-100">
                            <img src="assets/images/PlungePoolAC/4.jpg" alt="Thumbnail 4" class="w-full h-full object-cover">
                        </button>
                        <button onclick="changeImage('assets/images/PlungePoolAC/5.jpg', 4)" class="w-[140px] h-[140px] rounded-lg overflow-hidden transition-all opacity-80 hover:opacity-100">
                            <img src="assets/images/PlungePoolAC/5.jpg" alt="Thumbnail 5" class="w-full h-full object-cover">
                        </button>
                        <button onclick="changeImage('assets/images/PlungePoolAC/6.jpg', 5)" class="w-[140px] h-[140px] rounded-lg overflow-hidden transition-all opacity-80 hover:opacity-100">
                            <img src="assets/images/PlungePoolAC/6.jpg" alt="Thumbnail 6" class="w-full h-full object-cover">
                        </button>
                        <button onclick="changeImage('assets/images/PlungePoolAC/7.jpg', 6)" class="w-[140px] h-[140px] rounded-lg overflow-hidden transition-all opacity-80 hover:opacity-100">
                            <img src="assets/images/PlungePoolAC/7.jpg" alt="Thumbnail 7" class="w-full h-full object-cover">
                        </button>
                        <button onclick="changeImage('assets/images/PlungePoolAC/8.png', 7)" class="w-[140px] h-[140px] rounded-lg overflow-hidden transition-all opacity-80 hover:opacity-100">
                            <img src="assets/images/PlungePoolAC/8.png" alt="Thumbnail 8" class="w-full h-full object-cover">
                        </button>
                    </div>
                </div>
                ...
                <div data-aos="fade-left">
                    <div class="mb-8">
                        ...
                        <ul class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <li class="flex items-start bg-amber-50/50 dark:bg-gray-700/50 p-3 rounded-lg" data-aos="fade-up" data-aos-duration="300">
                                ...
                                <span class="text-gray-700 dark:text-gray-300">King-sized bed</span>
                            </li>
                            <li class="flex items-start bg-amber-50/50 dark:bg-gray-700/50 p-3 rounded-lg" data-aos="fade-up" data-aos-duration="300" data-aos-delay="50">
                                <i data-lucide="check" class="text-amber-600 dark:text-amber-400 w-5 h-5 mr-2 mt-0.5 flex-shrink-0"></i>
                                <span class="text-gray-700 dark:text-gray-300">Private plunge pool (non-AC)</span>
                            </li>
                            <li class="flex items-start bg-amber-50/50 dark:bg-gray-700/50 p-3 rounded-lg" data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
                                <i data-lucide="check" class="text-amber-600 dark:text-amber-400 w-5 h-5 mr-2 mt-0.5 flex-shrink-0"></i>
                                <span class="text-gray-700 dark:text-gray-300">Spacious open-air bathroom</span>
                            </li>
                            <li class="flex items-start bg-amber-50/50 dark:bg-gray-700/50 p-3 rounded-lg" data-aos="fade-up" data-aos-duration="300" data-aos-delay="150">
                                <i data-lucide="check" class="text-amber-600 dark:text-amber-400 w-5 h-5 mr-2 mt-0.5 flex-shrink-0"></i>
                                <span class="text-gray-700 dark:text-gray-300">Private sit-out with valley views</span>
                            </li>
                            <li class="flex items-start bg-amber-50/50 dark:bg-gray-700/50 p-3 rounded-lg" data-aos="fade-up" data-aos-duration="300" data-aos-delay="200">
                                <i data-lucide="check" class="text-amber-600 dark:text-amber-400 w-5 h-5 mr-2 mt-0.5 flex-shrink-0"></i>
                                <span class="text-gray-700 dark:text-gray-300">Complimentary welcome drink</span>
                            </li>
                            ...
                            <li class="flex items-start bg-amber-50/50 dark:bg-gray-700/50 p-3 rounded-lg" data-aos="fade-up" data-aos-duration="300" data-aos-delay="300">
                                <i data-lucide="check" class="text-amber-600 dark:text-amber-400 w-5 h-5 mr-2 mt-0.5 flex-shrink-0"></i>
                                <span class="text-gray-700 dark:text-gray-300">Premium bath amenities</span>
                            </li>
                            <li class="flex items-start bg-amber-50/50 dark:bg-gray-700/50 p-3 rounded-lg" data-aos="fade-up" data-aos-duration="300" data-aos-delay="350">
                                <i data-lucide="check" class="text-amber-600 dark:text-amber-400 w-5 h-5 mr-2 mt-0.5 flex-shrink-0"></i>
                                <span class="text-gray-700 dark:text-gray-300">Romantic lighting</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-gradient-to-r from-amber-50 to-amber-100 dark:from-gray-700 dark:to-gray-800 p-6 rounded-2xl border border-amber-200 dark:border-gray-600 mb-8">
                        <h3 class="text-xl font-semibold mb-3">Exclusive Couples Experiences</h3>
                        <ul class="space-y-2">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700 dark:text-gray-300">Private poolside dining available</span>
                            </li>
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700 dark:text-gray-300">Couples spa & massage packages</span>
                            </li>
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700 dark:text-gray-300">Sunset bonfire setup</span>
                            </li>
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700 dark:text-gray-300">Guided nature walks</span>
                            </li>
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-700 dark:text-gray-300">Romantic balcony dining</span>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="flex flex-col h-full">
                                ...
                                <div class="mt-auto">
                                    <div class="flex items-end gap-2 mb-1">
                                        <span class="text-3xl font-bold text-gray-800 dark:text-white">₹12,000</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="text-xs line-through text-gray-500 dark:text-gray-400">₹14,000</span>
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-1 gap-10">
                <div class="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8 sm:p-10 shadow-xl hover:shadow-2xl transition-all duration-500" data-aos="fade-up">
                    <p class="text-sm font-medium text-center text-amber-400 mb-3 uppercase tracking-wider">Plunge Pool Cottage Package</p>
                    <h2 class="text-4xl text-center sm:text-4xl font-bold text-white mb-8 leading-tight">
                        Nature & Romance at <span class="text-amber-400">Wildernest</span>
                    </h2>
                    <div class="space-y-6 mb-10">
                        <p class="text-gray-100 text-center leading-relaxed">
                            Your stay includes exclusive activities and amenities designed for couples seeking a private, nature-inspired getaway.
                        </p>
                    </div>
                    <div class="flex flex-col justify-center sm:flex-row sm:flex-wrap gap-4 mt-8">
                        <div class="flex items-center gap-3 border-2 border-white/20 hover:border-amber-400 text-white px-6 py-3 rounded-xl transition-all">
                            <i data-lucide="droplets" class="w-5 h-5 text-amber-400"></i>
                ...
                <div data-aos="fade-right">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-8">
                        <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                            <h3 class="text-xl font-semibold mb-2">Plunge Pool Cottage</h3>
                            <p class="text-gray-600 dark:text-gray-400 mb-4">All-inclusive nature-inspired package for couples</p>
                            <div class="flex items-end gap-2">
                                <span class="text-3xl font-bold text-amber-600 dark:text-amber-400">₹12,000</span>
                                <span class="text-gray-500 line-through">₹12,500</span>
                    ...
                    <div class="bg-amber-50 dark:bg-gray-700 rounded-xl p-6 border border-amber-100 dark:border-gray-600">
                        <h3 class="font-semibold text-lg mb-3">Special Romance Packages</h3>
                        <p class="text-gray-700 dark:text-gray-300 mb-4">Enhance your stay with these romantic additions:</p>
                    ...
                    <div class="sticky top-24">
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                            ...
                            <div class="p-6 bg-gradient-to-r from-amber-500 to-amber-600 dark:from-amber-600 dark:to-amber-700">
                                <h3 class="text-xl font-semibold text-white text-center">Book Your Plunge Pool Escape</h3>
                            </div>

                            <!-- Body -->
                            <div class="p-6">
                                <!-- Form Fields -->
                                <form id="plungePoolBookingForm" action="handlers/email-handler.php" method="POST" class="space-y-5">
                                    <input type="hidden" name="form_type" value="plunge_pool">
                        ...
                        <div class="bg-amber-50 dark:bg-gray-700 mt-8 p-6 rounded-xl border border-amber-200 dark:border-gray-600 mb-8">
                            ...
                            <ul class="space-y-2">
                                <li class="flex items-start">
                                    <span class="bg-amber-600 text-white rounded-full w-5 h-5 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0 text-xs">1</span>
                                    <span class="text-gray-700 dark:text-gray-300">Couples only - no extra person allowed</span>
                                </li>
                                <li class="flex items-start">
                                    <span class="bg-amber-600 text-white rounded-full w-5 h-5 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0 text-xs">2</span>
                                    <span class="text-gray-700 dark:text-gray-300">No children permitted in this cottage type</span>
                                </li>
                                <li class="flex items-start">
                                    <span class="bg-amber-600 text-white rounded-full w-5 h-5 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0 text-xs">3</span>
                                    <span class="text-gray-700 dark:text-gray-300">Non-AC accommodation for a true nature experience</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-right">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-300 mb-6">
                        Our Private Plunge Pool cottages are situated on a private hillside in North Goa, offering both tranquility and spectacular views.
                    </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-medium mb-1">Exclusive Privacy</h4>
                                <p class="text-gray-600 dark:text-gray-400">Secluded location with maximum privacy for couples</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="bg-amber-100 dark:bg-amber-900/30 p-3 rounded-full mt-0.5">
                ...
                <div data-aos="fade-left">
                    <div class="rounded-2xl overflow-hidden shadow-xl">
                        <img src="assets/images/PlungePoolAC/5.jpg" alt="Resort Location" class="w-full h-96 object-cover">
                    </div>
                </div>
            </div>
        </div>
...
const images = [
    'assets/images/PlungePoolAC/1.jpg',
    'assets/images/PlungePoolAC/2.png',
    'assets/images/PlungePoolAC/3.jpg',
    'assets/images/PlungePoolAC/4.jpg'
];
...
<?php echo getRecaptchaFormScript('plungePoolBookingForm', 'plunge_pool_booking'); ?>
